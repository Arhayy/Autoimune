            ...
            <div class="col-md-10 offset-md-1">
                ...
                <form action="" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                        <input type="text" name="id" class="form-control" value="<?php echo $r['id_autoimune']; ?>" hidden>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-form-label">Gambar</label><br>
                        <img src="images/<?php echo $r['gambar']; ?>" alt="" width="200"><br><br>
...
if (isset($_POST['simpan'])) {
    ...
    if ($terupload) {
        $query = mysqli_query($koneksi, "UPDATE autoimune SET gambar='$namaFile', judul='$judul', ket_singkat='$ket1', ket_lengkap='$ket2' WHERE id_autoimune='$id' ");
